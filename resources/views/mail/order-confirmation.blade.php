...
<tr>
	<td>
		...
		<tr width="640" style="width: 640px; min-width: 640px; " align="center">
						...
						<td align="left">
							...
							<tr>
								<td>
									...
									<tr>
                                        <td align="center" style="color:#FFFFFF;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:800;font-size:30px;-webkit-font-smoothing:antialiased;line-height:1.2;" class="table-container mobile-title">
                                            Swanky Collections
                                        </td>
									</tr>
									</table>
			...
			<tr>
				<td align="center">
                    <div><i style="font-size: 100px;color:aquamarine" class="bi bi-check-circle-fill"></i></div>
				</td>
			</tr>
			</tbody>
			</table>
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="width: 100%; min-width: 640px;" role="presentation" bgcolor="#FFFFFF">
			<tbody>
			<tr>
				<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="width: 100%; min-width: 640px;" role="presentation" bgcolor="#FFFFFF">
				<tbody>
				<tr>
					<td bgcolor="#FFF" width="20" align="left" style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
					</td>
			...
			<tbody>
			<tr>
				<td align="center" style="color:#FFFFFF;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:800;font-size:30px;-webkit-font-smoothing:antialiased;line-height:1.2;" class="table-container mobile-title">
					 Want More ?
				</td>
			</tr>
			<tr>
				<td align="center" style="padding:40px 40px 10px 40px;" class="table-container">
					<a href="{{ $appsetting->app_url }}" style="background-color: #ff5746; color: #FFFFFF; display: inline-block;font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 20px; text-align: center; font-weight: bold; text-decoration: none; padding: 20px 25px; min-width: 150px; -webkit-text-size-adjust: none;">Shop Now</a>
				</td>
			</tr>
			</tbody>
			</table>
			<table bgcolor="#4f48e0" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" role="presentation" class="table-container ">
			<tr>
				<td height="60" style="line-height:60px;min-height:60px;">
				</td>
			</tr>
			...
			<table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;-webkit-text-fill-color: #f1f1f1;" role="presentation" class="table-container ">
			<tr>
				<td height="35" style="line-height:35px;min-height:35px;">
				</td>
			</tr>
			...
			<table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" role="presentation" class="table-container ">
			<tr>
				<td style="color:#444444; font-size:14px; line-height:22px; text-align:center;border:none;font-weight:bold;">
					 © 2024 Swanky Collections, Inc. <br>
				</td>
			</tr>
			</table>
			<table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" role="presentation" class="table-container ">
