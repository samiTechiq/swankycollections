                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="mailto:info@example.com">{{ $appsetting->email }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <p class="contact-info">{{ $appsetting->address }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="tel:{{ $appsetting->phone }}">{{ $appsetting->phone }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <form wire:submit="save" class="contact-form">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" wire:model="name" class="@error('name') is-invalid @enderror" placeholder="Full name" />
                                        @error('name')
                                ...
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="email" wire:model="email" class="@error('email') is-invalid @enderror" placeholder="Email Address*" />
                                        @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" wire:model="subject" class="@error('subject') is-invalid @enderror" placeholder="Type a subject" />
                                        @error('subject')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" wire:model="phone" class="@error('phone') is-invalid @enderror" placeholder="Phone Number" />
                                        @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-md-12 col-12">
                                    <fieldset>
                                        <textarea wire:model="message" cols="20" rows="6" placeholder="Write your message here*"></textarea>
                                        @error('message')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </fieldset>
                                    <button type="submit" class="position-relative review-submit-btn contact-submit-btn">
