        ...
        <tbody>
            @forelse ($colors as $color)
                <tr :key="$color->id">
                    ...
                    <td>
                        <button wire:click="edit({{ $color->id }})" class="badge bg-warning border-0">
            ...
            @empty
                <tr>
                    <td colspan="3" style="text-align: center">No Color for this product yet</td>
                </tr>
            @endforelse
        </tbody>
    </table>
...
<div wire:ignore.self class="modal fade" id="addColorModal" tabindex="-1" aria-labelledby="addColorModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Add Product Color</h1>
  ...
  <!-- Modal edit -->
  <div wire:ignore.self class="modal fade" id="colorEditModal" tabindex="-1" aria-labelledby="colorEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Update Product Color</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
