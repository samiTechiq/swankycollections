...
@section('adm-title', 'Create Banner')
@section('contents')
    ...
    <div class="row">
        <div class="col-12">
           <div class="mb-3">
                ...
                <input type="text" name="first_title" value="{{ old('first_title') }}" class="form-control @error('first_title') is-invalid @enderror">
                @error('first_title')
           ...
           <div class="mb-3">
                ...
                <input type="text" name="second_title" value="{{ old('second_title') }}" class="form-control @error('second_title') is-invalid @enderror">
                @error('second_title')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
           </div>
           <div class="mb-3">
                ...
                <input type="text" name="third_title" value="{{ old('third_title') }}" class="form-control @error('third_title') is-invalid @enderror">
                @error('third_title')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
